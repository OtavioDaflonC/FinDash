                        ...
                        html.Div(
                            ...
                            children=[
                                ...
                                dcc.Loading(
                                    ...
                                    type="circle",
                                    children=[
                                        dcc.Graph(id="monte_carlo_graph", figure=create_placeholder_figure()),
                                    ],
...
@dash.callback(
    Output("header-animation_", "figure"),
...
@dash.callback(
    Output("monte_carlo_graph", "figure"),  # Atualiza o gráfico principal
    [
    ...
    [State("input-stock", "value")]  # Estado do campo de texto
)
def update_graph( calc_button,ticker_input):#btn1_clicks, btn2_clicks,
    ...
    if triggered_input == "calculate-button2" and ticker_input:
        ...
        hist_fig, mcpred_fig,proba_fig,var_out,es5_out = monte_carlo_pred(ticker_input,start_date="2020-01-01",end_date="2024-01-01",simul_length=300)

        return mcpred_fig  # Gráfico atualizado com os dados fornecidos
